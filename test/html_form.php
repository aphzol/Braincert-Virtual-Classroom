...
<table>
	...
	<tr>
		...
		<td>
			<a href="html_form.php?show=getclassreport">Get Class Usage Report</a>
		</td>
	</tr>
</table>
    ...
    <div class="control-group">
        ...
        <label class="control-label" style="margin-left: 6px;">Ends:</label>
         ...
         <div class="control-group">
            ...
            <div class="controls">
            <input type="radio" id="allow_change_language_1" name="allow_change_interface_language" value="1" checked>Yes
        ...
        <div class="control-group" style="clear:both;" id="force_language">
                    <label class="span1 hasTip">Force Interface Language:</label>
                    <div class="controls">
                    <select class="in-selection required form-control" id="language" name="language">
    			    <?php  foreach($langarray as $key=>$val){  ?>
                         <option value="<?php echo $key;?>" <?php echo $key==11 ? 'selected' : '';?>><?php echo $val;?></option>
                    <?php } ?>
    	            </select>
                <br />
                <br />
        ...
        <div class="control-group">
			...
			<input type="radio" name="record" value="0" checked>No
            </div>
       	</div>
       	<div class="control-group record_auto">
            ...
            <select class="in-selection required form-control" id="isRecordingLayout" name="isRecordingLayout">
                <option value="0">Standard view (Whiteboard, Videos and Chat view with no icons)</option>
                <option value="1">Enhanced view (Entire browser tab with all the icons)</option>
            </select>
        </div>
       	<div class="control-group record_auto">
        ...
        <div class="control-group video_delivery">
...
<?php if($_REQUEST['show'] == 'getclassreport'){ ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
        ...
        <div class="control-group">
       	...
       	<div class="control-group">
          	<label class="span1 hasTip" for="User Name"  title="User Name">User Id:</label>
            <div class="controls">
         ...
         <div class="control-group">
          <div class="controls">
         <button class="btn btn-primary" id="save_button" type="button" style="font-weight: bold;">Get Class Usage Report</button>
         </div>
         </div>
    </form>
